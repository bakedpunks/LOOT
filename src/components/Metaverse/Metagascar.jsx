...
const Metagascar = ({ connectToMetamask }) => {
  return (
    ...
    <a-scene networked-scene="serverURL: ws://149.248.10.154:5001; app: metagascar; room: metagascar; connectOnLoad: true; onConnect: onConnect; adapter: wseasyrtc; audio: false; video: false; debug: true;" >
        <a-assets>
