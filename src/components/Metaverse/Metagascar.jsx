...
const Metagascar = ({ connectToMetamask }) => {
  return (
    ...
    <a-scene >
        ...
        <a-entity environment="preset: forest; lightPosition: 1 5 -2; groundColor: green; ground: flat; groundTexture: walkernoise;dressing: mushrooms; dressingAmount: 100; playArea: 440;"></a-entity>
       {items}
