...
const Metagascar = ({ connectToMetamask }) => {
  return (
    ...
    <a-scene networked-scene="serverURL: / ; app: metagascar; room: metagascar; connectOnLoad: true; onConnect: onConnect; adapter: websocket; audio: false; video: false; debug: true;" >
        <a-assets>
