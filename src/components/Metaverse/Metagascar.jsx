...
const Metagascar = ({ connectToMetamask }) => {
  return (
    ...
    <a-scene networked-scene="serverURL:  ws://149.258.10.154:8080/socket.io ; app: metagascar; room: metagascar; connectOnLoad: true; onConnect: onConnect; adapter: wseasyrtc; audio: false; video: false; debug: true;" >
        <a-assets>
