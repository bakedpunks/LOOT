...
const Metagascar = ({ connectToMetamask }) => {
  return (
    ...
    <a-scene networked-scene="serverURL: ws://wsrtcmetagascar.herokuapp.com:8080; app: metagascar; room: metagascar; connectOnLoad: true; onConnect: onConnect; adapter: webrtc; audio: false; video: false; debug: true;" >
        <a-assets>
