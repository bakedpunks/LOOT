...
const Metagascar = ({ connectToMetamask }) => {
  return (
    ...
    <a-scene networked-scene="serverURL: ws://149.248.10.154:8080/socket.io/; app: metagascar; room: metagascar; connectOnLoad: true; onConnect: onConnect; adapter: webrtc; audio: false; video: false; debug: true;" >
        <a-assets>
